...
def run_lab_where_generating_graphs():
    ...
    write_graph_inspection_to_file('graph_equal_1.txt', 'g1', g1_i, f'N={N} p={p1}\n========================\n')
    write_graph_inspection_to_file('graph_equal_2.txt', 'g2', g2_i, f'N={N} p={p2}\n========================\n')
    write_graph_inspection_to_file('graph_equal_3.txt', 'g3', g3_i, f'N={N} p={p3}\n========================\n')
